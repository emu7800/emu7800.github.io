...
/// <summary>
/// Atari 7800 Bankset Bankswitched cartridge - 2x52K w/Pokey@4000
/// </summary>
public sealed class Cart78BB52KP : Cart78BB
{
    ...
    public Cart78BB52KP(byte[] romBytes)
    {
    ...
    public Cart78BB52KP(DeserializationContext input, MachineBase m) : base(input)
    {
